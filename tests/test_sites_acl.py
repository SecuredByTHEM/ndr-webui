...
class TestSitesACL(unittest.TestCase):
    '''Tests site ACL class'''
    ...
    def test_site_access_by_admin(self):
        ...
        with self.flask_app.app_context():
            ...
            site_acl = ndr_webui.SiteACL.read_by_id(
                nsc, admin_user, site.pg_id, db_conn
            )

            self.assertEqual(site, site_acl)
